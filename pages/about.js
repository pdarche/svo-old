      ...
      <div {...styles}>
        ...
        <div {...content}>
          <div {...text}>
            ...
            <h2>Data Privacy</h2>
            <p>The data associated with this survey will not be shared with anyone.  Information will never be posted to facebook and the only you and the research team will see anything associated with application.  Most data is stored on your computer and only sent to us once over a secure connection.</p>
          </div>
        </div>
      </div>
    )
